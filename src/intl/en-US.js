export default {
  ...
  composeStatus: 'What did you smoke today?',
  postStatus: 'PASS IT',
  contentWarning: 'Content warning',
  dropToUpload: 'Drop to upload',
  invalidFileType: 'Invalid file type',
  composeLabel: "What did you smoke today?",
  ...
  unableToLoadStatuses: 'Unable to load recent puffs: {error}',
  report: 'Report',
  noContent: '(No content)',
  noStatuses: 'No  to report',
  // Status options
